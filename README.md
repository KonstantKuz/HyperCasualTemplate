...
В LevelManager.cs в методах старта и обновления прогресса есть закомментированиые строки вызова методов TinySauce аналитики.  
После импорта аналитики в проект достаточно добавить префаб аналитики в Preload сцену и раскомментировать эти две строки в LevelManager.  
